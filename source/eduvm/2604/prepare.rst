...
2. Instalacja systemu:
   ...
   * Xubuntu ISO: https://ubuntu.ipacct.com/xubuntu/26.04.1/release/xubuntu-26.04-minimal-amd64.iso.torrent
   * Keyboard: English (US)
...
3. Konfiguracja systemu
   ...
   * Uruchomienie konfiguracji, repo tag: https://github.com/chyla/eduvm-preparation/tree/eduvm-2604
