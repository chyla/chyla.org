...
2. Instalacja systemu:
   ...
   * Xubuntu ISO: `xubuntu-25.04-minimal-amd64.iso <https://torrent.ubuntu.com/xubuntu/releases/plucky/release/minimal/xubuntu-25.04-minimal-amd64.iso.torrent>`__
   * Keyboard: English (US)
...
3. Konfiguracja systemu
   ...
   * Uruchomienie konfiguracji, repo tag: https://github.com/chyla/eduvm-preparation/tree/eduvm-2504
